...
CXChildVisitResult func_def_collect_visitor(const CXCursor &cursor,
...
insecure_world_func_def_collect_visitor(CXCursor cursor, CXCursor parent,
  ...
  return func_def_collect_visitor<WorldType::INSECURE_WORLD>(cursor, parent,
                                                             clientData);
}
...
secure_world_func_def_collect_visitor(CXCursor cursor, CXCursor parent,
                                      CXClientData clientData) {
  return func_def_collect_visitor<WorldType::SECURE_WORLD>(cursor, parent,
                                                           clientData);
}
