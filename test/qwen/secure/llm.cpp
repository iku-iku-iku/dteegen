...
int run(const char* prompt)
{
    ...
    //     LOG_TEE("%s: warning: minimum context size is 8, using minimum
    //     size.\n",
    //             __func__);
    //     params.n_ctx = 8;
    // }
    ...
    //     // grp_attn_n"); // NOLINT
    //     LOG_TEE(
    //         "self-extend: n_ctx_train = %d, grp_attn_n = %d, grp_attn_w =
...
//     defined(_WIN32)
    ...
    while (n_remain != 0) {
        ...
        if (!embd.empty()) {
            ...
            //                          llama_batch_get_one(input_buf + i,
            //                          n_eval,
            //                                              n_past_guidance,
            //                                              0))) {
        ...
        if ((int)embd_inp.size() <= n_consumed) {
            ...
            // processing
            // eapp_print("embd_inp.size(): %d, n_consumed: %d\n",
