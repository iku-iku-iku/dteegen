...
struct ModelConfig {
  ...
  const unsigned char *encoder_param_data;  // data of encoder.ncnn.param
  const unsigned char *encoder_bin_data;    // data of encoder.ncnn.bin
  const unsigned char *decoder_param_data;  // data of decoder.ncnn.param
  const unsigned char *decoder_bin_data;    // data of decoder.ncnn.bin
  const unsigned char *joiner_param_data;   // data of joiner.ncnn.param
  const unsigned char *joiner_bin_data;     // data of joiner.ncnn.bin
  const unsigned char *tokens_data;         // data of tokens.txt
  size_t tokens_size;
...
class Model {
 ...
 protected:
  ...
  static void InitNet(ncnn::Net &net, const unsigned char *param_data,
