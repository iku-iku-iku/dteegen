...
class ZipformerModel : public Model {
 ...
 private:
  void InitEncoder(const unsigned char *encoder_param_data,
                   const unsigned char *encoder_bin_data);
  void InitDecoder(const unsigned char *decoder_param_data,
                   const unsigned char *decoder_bin_data);
  void InitJoiner(const unsigned char *joiner_param_data,
