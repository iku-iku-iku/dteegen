...
ZipformerModel::ZipformerModel(const ModelConfig &config) {
  ...
  InitEncoder(config.encoder_param_data, config.encoder_bin_data);
  InitDecoder(config.decoder_param_data, config.decoder_bin_data);
  InitJoiner(config.joiner_param_data, config.joiner_bin_data);
...
void ZipformerModel::InitEncoderPostProcessing() {
  ...
  // for (const auto *layer : encoder_.layers()) {
    // if (layer->type == "SherpaMetaData" && layer->name == "sherpa_meta_data1") 
    {
      ...
      const auto *meta_data = reinterpret_cast<const MetaData *>(encoder_.layers()[0]);
...
void ZipformerModel::InitEncoder(const unsigned char *encoder_param_data,
                                 const unsigned char *encoder_bin_data) {
  RegisterCustomLayers(encoder_);
  InitNet(encoder_, encoder_param_data, encoder_bin_data);
  InitEncoderPostProcessing();
}

void ZipformerModel::InitDecoder(const unsigned char *decoder_param_data,
                                 const unsigned char *decoder_bin_data) {
  InitNet(decoder_, decoder_param_data, decoder_bin_data);
}

void ZipformerModel::InitJoiner(const unsigned char *joiner_param_data,
                                const unsigned char *joiner_bin_data) {
  InitNet(joiner_, joiner_param_data, joiner_bin_data);
}
...
void ZipformerModel::InitEncoderInputOutputIndexes() {
  ...
  // ... ...
  encoder_input_indexes_ = {
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in0,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in1,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in2,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in3,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in4,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in5,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in6,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in7,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in8,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in9,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in10,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in11,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in12,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in13,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in14,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in15,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in16,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in17,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in18,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in19,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in20,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in21,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in22,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in23,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in24,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in25,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in26,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in27,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in28,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in29,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in30,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in31,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in32,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in33,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in34,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_in35,
  };
  ...
  // ... ...
  encoder_output_indexes_ = {
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out0,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out1,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out2,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out3,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out4,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out5,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out6,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out7,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out8,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out9,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out10,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out11,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out12,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out13,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out14,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out15,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out16,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out17,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out18,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out19,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out20,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out21,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out22,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out23,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out24,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out25,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out26,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out27,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out28,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out29,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out30,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out31,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out32,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out33,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out34,
    encoder_jit_trace_pnnx_ncnn_param_id::BLOB_out35,
  };
...
void ZipformerModel::InitDecoderInputOutputIndexes() {
  // input indexes map
  // [0] -> in0, decoder_input,
  decoder_input_indexes_ = {
    decoder_jit_trace_pnnx_ncnn_param_id::BLOB_in0
  };
  decoder_output_indexes_ = {
    decoder_jit_trace_pnnx_ncnn_param_id::BLOB_out0
  };
...
void ZipformerModel::InitJoinerInputOutputIndexes() {
  ...
  // [0] -> in0, encoder_input,
  // [1] -> in1, decoder_input,
  joiner_input_indexes_ = {
    joiner_jit_trace_pnnx_ncnn_param_id::BLOB_in0,
    joiner_jit_trace_pnnx_ncnn_param_id::BLOB_in1,
  };
  joiner_output_indexes_ = {
    joiner_jit_trace_pnnx_ncnn_param_id::BLOB_out0
  };
